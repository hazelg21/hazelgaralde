...
export default function PortfolioPage() {
    ...
    const projectsArray = [{
        ...
        desc: "Hermosa is an e-commerce website for selling hair products. This website was created using React, HTML, CSS, and Javascript for the front-end. For the back-end, I used MongoDB, NodeJS, and ExpressJS. I am still in the process of adding additional features and updating the design and mobile responsiveness.",
        ...
        f_end: "ReactJS",
        b_end: "NodeJS, MongoDB",
        desc: "Time Tracker App is one of my ongoing projects. When working on a project it is important to monitor the steps taken to fix issues and create features. The time tracker app will help determine which tag and activity took the most time to do.",
